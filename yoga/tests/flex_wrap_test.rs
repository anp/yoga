...
use yoga::{Align, Direction, Edge, FlexDirection, Justify, Node, Undefined, Value, Wrap};
...
fn test_wrap_column() {
    ...
    root_child0.set_width(Value::Point(30.0.into()));
    root_child0.set_height(Value::Point(30.0.into()));
    root.insert_child(&mut root_child0, 0);

    let mut root_child1 = Node::new();
    root_child1.set_width(Value::Point(30.0.into()));
    root_child1.set_height(Value::Point(30.0.into()));
    root.insert_child(&mut root_child1, 1);

    let mut root_child2 = Node::new();
    root_child2.set_width(Value::Point(30.0.into()));
    root_child2.set_height(Value::Point(30.0.into()));
    root.insert_child(&mut root_child2, 2);

    let mut root_child3 = Node::new();
    root_child3.set_width(Value::Point(30.0.into()));
    root_child3.set_height(Value::Point(30.0.into()));
...
fn test_wrap_row_align_items_flex_end() {
    ...
    let mut root_child1 = Node::new();
    root_child1.set_width(Value::Point(30.0.into()));
    root_child1.set_height(Value::Point(20.0.into()));
    root.insert_child(&mut root_child1, 1);
...
fn test_flex_wrap_children_with_min_main_overriding_flex_basis() {
    ...
    let mut root_child0 = Node::new();
    root_child0.set_flex_basis(Value::Point(50.0.into()));
    root_child0.set_min_width(Value::Point(55.0.into()));
    root_child0.set_height(Value::Point(50.0.into()));
    root.insert_child(&mut root_child0, 0);

    let mut root_child1 = Node::new();
    root_child1.set_flex_basis(Value::Point(50.0.into()));
    root_child1.set_min_width(Value::Point(55.0.into()));
...
fn test_flex_wrap_wrap_to_child_height() {
    ...
    root_child0_child0.set_width(Value::Point(100.0.into()));
    root_child0.insert_child(&mut root_child0_child0, 0);

    let mut root_child0_child0_child0 = Node::new();
    root_child0_child0_child0.set_width(Value::Point(100.0.into()));
    root_child0_child0_child0.set_height(Value::Point(100.0.into()));
    root_child0_child0.insert_child(&mut root_child0_child0_child0, 0);

    let mut root_child1 = Node::new();
    root_child1.set_width(Value::Point(100.0.into()));
...
fn test_flex_wrap_align_stretch_fits_one_row() {
    ...
    root.set_flex_direction(FlexDirection::Row);
    root.set_flex_wrap(Wrap::Wrap);
    root.set_width(Value::Point(150.0.into()));
    root.set_height(Value::Point(100.0.into()));
...
fn test_wrap_reverse_row_align_content_flex_start() {
    ...
    let mut root_child3 = Node::new();
    root_child3.set_width(Value::Point(30.0.into()));
    root_child3.set_height(Value::Point(40.0.into()));
    root.insert_child(&mut root_child3, 3);

    let mut root_child4 = Node::new();
    root_child4.set_width(Value::Point(30.0.into()));
    root_child4.set_height(Value::Point(50.0.into()));
...
fn test_wrap_reverse_row_single_line_different_size() {
    ...
    root.set_flex_direction(FlexDirection::Row);
    root.set_flex_wrap(Wrap::WrapReverse);
    root.set_width(Value::Point(300.0.into()));
...
fn test_wrapped_row_within_align_items_center() {
    ...
    let mut root_child0_child0 = Node::new();
    root_child0_child0.set_width(Value::Point(150.0.into()));
    root_child0_child0.set_height(Value::Point(80.0.into()));
    root_child0.insert_child(&mut root_child0_child0, 0);

    let mut root_child0_child1 = Node::new();
    root_child0_child1.set_width(Value::Point(80.0.into()));
    root_child0_child1.set_height(Value::Point(80.0.into()));
...
fn test_wrapped_column_max_height() {
    ...
    root.set_align_items(Align::Center);
    root.set_flex_wrap(Wrap::Wrap);
    root.set_width(Value::Point(700.0.into()));
    root.set_height(Value::Point(500.0.into()));

    let mut root_child0 = Node::new();
    root_child0.set_width(Value::Point(100.0.into()));
    root_child0.set_height(Value::Point(500.0.into()));
    root_child0.set_max_height(Value::Point(200.0.into()));
    root.insert_child(&mut root_child0, 0);

    let mut root_child1 = Node::new();
    root_child1.set_margin(Edge::Left, Value::Point(20.0.into()));
    root_child1.set_margin(Edge::Top, Value::Point(20.0.into()));
    root_child1.set_margin(Edge::Right, Value::Point(20.0.into()));
    root_child1.set_margin(Edge::Bottom, Value::Point(20.0.into()));
    root_child1.set_width(Value::Point(200.0.into()));
    root_child1.set_height(Value::Point(200.0.into()));
    root.insert_child(&mut root_child1, 1);

    let mut root_child2 = Node::new();
    root_child2.set_width(Value::Point(100.0.into()));
    root_child2.set_height(Value::Point(100.0.into()));
    root.insert_child(&mut root_child2, 2);
    root.calculate_layout(Undefined, Undefined, Direction::LTR);
...
fn test_wrapped_column_max_height_flex() {
    ...
    root_child0.set_flex_basis(Value::Percent(0.0.into()));
    root_child0.set_width(Value::Point(100.0.into()));
    root_child0.set_height(Value::Point(500.0.into()));
    root_child0.set_max_height(Value::Point(200.0.into()));
    root.insert_child(&mut root_child0, 0);
    ...
    root_child1.set_flex_basis(Value::Percent(0.0.into()));
    root_child1.set_margin(Edge::Left, Value::Point(20.0.into()));
    root_child1.set_margin(Edge::Top, Value::Point(20.0.into()));
    root_child1.set_margin(Edge::Right, Value::Point(20.0.into()));
    root_child1.set_margin(Edge::Bottom, Value::Point(20.0.into()));
...
fn test_wrap_nodes_with_content_sizing_overflowing_margin() {
    ...
    root_child0.set_flex_direction(FlexDirection::Row);
    root_child0.set_flex_wrap(Wrap::Wrap);
    root_child0.set_width(Value::Point(85.0.into()));
    root.insert_child(&mut root_child0, 0);
    ...
    let mut root_child0_child0_child0 = Node::new();
    root_child0_child0_child0.set_width(Value::Point(40.0.into()));
    root_child0_child0_child0.set_height(Value::Point(40.0.into()));
    root_child0_child0.insert_child(&mut root_child0_child0_child0, 0);

    let mut root_child0_child1 = Node::new();
    root_child0_child1.set_margin(Edge::Right, Value::Point(10.0.into()));
    root_child0.insert_child(&mut root_child0_child1, 1);

    let mut root_child0_child1_child0 = Node::new();
    root_child0_child1_child0.set_width(Value::Point(40.0.into()));
    root_child0_child1_child0.set_height(Value::Point(40.0.into()));
...
fn test_wrap_nodes_with_content_sizing_margin_cross() {
    ...
    root_child0.set_flex_direction(FlexDirection::Row);
    root_child0.set_flex_wrap(Wrap::Wrap);
    root_child0.set_width(Value::Point(70.0.into()));
    root.insert_child(&mut root_child0, 0);
    ...
    let mut root_child0_child1 = Node::new();
    root_child0_child1.set_margin(Edge::Top, Value::Point(10.0.into()));
    root_child0.insert_child(&mut root_child0_child1, 1);
