...
use yoga::{Direction, Edge, FlexDirection, Node, Undefined, Value};
...
fn test_rounding_flex_basis_flex_grow_row_prime_number_width() {
    let mut root = Node::new();
    root.set_flex_direction(FlexDirection::Row);
    root.set_width(Value::Point(113.0.into()));
    root.set_height(Value::Point(100.0.into()));
...
fn test_rounding_flex_basis_flex_shrink_row() {
    let mut root = Node::new();
    root.set_flex_direction(FlexDirection::Row);
    root.set_width(Value::Point(101.0.into()));
    root.set_height(Value::Point(100.0.into()));
    ...
    let mut root_child1 = Node::new();
    root_child1.set_flex_basis(Value::Point(25.0.into()));
    root.insert_child(&mut root_child1, 1);

    let mut root_child2 = Node::new();
    root_child2.set_flex_basis(Value::Point(25.0.into()));
    root.insert_child(&mut root_child2, 2);
    root.calculate_layout(Undefined, Undefined, Direction::LTR);
...
fn test_rounding_flex_basis_overrides_main_size() {
    let mut root = Node::new();
    root.set_width(Value::Point(100.0.into()));
    root.set_height(Value::Point(113.0.into()));

    let mut root_child0 = Node::new();
    root_child0.set_flex_grow(1.0);
    root_child0.set_flex_basis(Value::Point(50.0.into()));
    root_child0.set_height(Value::Point(20.0.into()));
    root.insert_child(&mut root_child0, 0);
...
fn test_rounding_total_fractial() {
    let mut root = Node::new();
    root.set_width(Value::Point(87.4.into()));
    root.set_height(Value::Point(113.4.into()));

    let mut root_child0 = Node::new();
    root_child0.set_flex_grow(0.7);
    root_child0.set_flex_basis(Value::Point(50.3.into()));
    root_child0.set_height(Value::Point(20.3.into()));
    root.insert_child(&mut root_child0, 0);
    ...
    root_child2.set_height(Value::Point(10.7.into()));
    root.insert_child(&mut root_child2, 2);
    root.calculate_layout(Undefined, Undefined, Direction::LTR);
...
fn test_rounding_total_fractial_nested() {
    ...
    root_child0_child0.set_flex_basis(Value::Point(0.3.into()));
    root_child0_child0.set_position(Edge::Bottom, Value::Point(13.3.into()));
    root_child0_child0.set_height(Value::Point(9.9.into()));
    root_child0.insert_child(&mut root_child0_child0, 0);

    let mut root_child0_child1 = Node::new();
    root_child0_child1.set_flex_grow(4.0);
    root_child0_child1.set_flex_basis(Value::Point(0.3.into()));
    root_child0_child1.set_position(Edge::Top, Value::Point(13.3.into()));
    root_child0_child1.set_height(Value::Point(1.1.into()));
...
fn test_rounding_fractial_input_2() {
    let mut root = Node::new();
    root.set_width(Value::Point(100.0.into()));
    root.set_height(Value::Point(113.6.into()));
...
fn test_rounding_fractial_input_3() {
    let mut root = Node::new();
    root.set_position(Edge::Top, Value::Point(0.3.into()));
    root.set_width(Value::Point(100.0.into()));
    root.set_height(Value::Point(113.4.into()));
...
fn test_rounding_fractial_input_4() {
    let mut root = Node::new();
    root.set_position(Edge::Top, Value::Point(0.7.into()));
    root.set_width(Value::Point(100.0.into()));
    root.set_height(Value::Point(113.4.into()));
...
fn test_rounding_inner_node_controversy_horizontal() {
    let mut root = Node::new();
    root.set_flex_direction(FlexDirection::Row);
    root.set_width(Value::Point(320.0.into()));
    ...
    root_child1_child0.set_height(Value::Point(10.0.into()));
...
fn test_rounding_inner_node_controversy_vertical() {
    let mut root = Node::new();
    root.set_height(Value::Point(320.0.into()));
    ...
    let mut root_child1_child0 = Node::new();
    root_child1_child0.set_flex_grow(1.0);
    root_child1_child0.set_width(Value::Point(10.0.into()));
    root_child1.insert_child(&mut root_child1_child0, 0);
...
fn test_rounding_inner_node_controversy_combined() {
    let mut root = Node::new();
    root.set_flex_direction(FlexDirection::Row);
    root.set_width(Value::Point(640.0.into()));
    root.set_height(Value::Point(320.0.into()));

    let mut root_child0 = Node::new();
    root_child0.set_flex_grow(1.0);
    root_child0.set_height(Value::Percent(100.0.into()));
    root.insert_child(&mut root_child0, 0);

    let mut root_child1 = Node::new();
    root_child1.set_flex_grow(1.0);
    root_child1.set_height(Value::Percent(100.0.into()));
    root.insert_child(&mut root_child1, 1);
    ...
    root_child1_child1.set_width(Value::Percent(100.0.into()));
    ...
    root_child1_child1_child0.set_width(Value::Percent(100.0.into()));
    ...
    root_child1_child2.set_width(Value::Percent(100.0.into()));
    root_child1.insert_child(&mut root_child1_child2, 2);

    let mut root_child2 = Node::new();
    root_child2.set_flex_grow(1.0);
    root_child2.set_height(Value::Percent(100.0.into()));
    root.insert_child(&mut root_child2, 2);
    root.calculate_layout(Undefined, Undefined, Direction::LTR);
